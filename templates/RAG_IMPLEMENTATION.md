...
1. **RETRIEVE**: Sempre busque primeiro em `docs/IA/CLEAN_CONTEXT.md`. Depois consulte, conforme o tema, arquivos de roadmap, planos de implementação e regras de negócio (**[LISTA_ARQUIVOS_CONTEXTO]**).
...
3. Regra de negócio específica em **[DIRETORIO_REGRAS_NEGOCIO]**.
4. `docs/IA/IMPLEMENTATION_PLAN.md`.
5. Outros documentos de arquitetura ou roadmap.
